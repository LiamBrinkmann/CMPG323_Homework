...
namespace _35301503_Homework.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ServicesController(CMPG323_HomeworkContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Services != null ? 
                          ...
                          Problem("Entity set 'CMPG323_HomeworkContext.Services'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'CMPG323_HomeworkContext.Services'  is null.");
            }
            var service = await _context.Services.FindAsync(id);
            if (service != null)
            {
