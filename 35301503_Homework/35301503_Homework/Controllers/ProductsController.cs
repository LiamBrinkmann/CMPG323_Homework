...
using _35301503_Homework.Repository;

namespace _35301503_Homework.Controllers
{
    public class ProductsController : Controller
    {
        private readonly CMPG323_HomeworkContext _context;

        public ProductsController(CMPG323_HomeworkContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(results);
             /*return _context.Products != null ? 
                          ...
                          Problem("Entity set 'CMPG323_HomeworkContext.Products'  is null."); */
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'CMPG323_HomeworkContext.Products'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
